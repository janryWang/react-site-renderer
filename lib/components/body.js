...
var getDefaultComponent = function getDefaultComponent(doc) {
  doc.__renderer = doc.__renderer || function (props) {
    ...
    }, doc.type === 'html' ? _react.default.createElement(doc && doc.component ? doc.component : _empty.default) : _react.default.createElement(_elevator.default, null, _react.default.createElement(doc && doc.component ? doc.component : _empty.default)));
  };
...
var SideMenu = function SideMenu(_ref2) {
  ...
  var content = dataSource.map(function (_ref3) {
    ...
    }, component ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_router.Link, {
      className: "menu-node",
      onClick: onClick,
      getProps: isActive,
      to: slug
...
var _default = (0, _styledComponents.withTheme)((0, _styledComponents.default)(function (_ref4) {
  ...
  return _react.default.createElement("div", {
    ...
    ref: bodyRef
  }, doc.children && doc.children.length && _react.default.createElement("div", {
    className: "site-nav",
    style: {
      overflow: 'auto'
    }
